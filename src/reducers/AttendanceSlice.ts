  ...
  const attendanceSlice = createSlice({
    ...
    reducers: {
        ...
        updateAttendance: (state, action) => {
            const index = state.findIndex(attendance => attendance.id === action.payload.id);
