...
function Sidebar({ isCollapsed, setIsCollapsed, isMobileMenuOpen }: SidebarProps) {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-30 h-screen transition-all duration-300 ease-in-out flex flex-col
    ...
    >
      ...
      <div className="p-4 border-t border-gray-200">
        <button
          ...
          className="w-full flex items-center p-3 rounded-lg bg-red-50 hover:bg-red-100 transition-colors"
        >
